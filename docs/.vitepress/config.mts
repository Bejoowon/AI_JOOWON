    ...
    sidebar: {
      '/': [
        ...
        { text: '2. 클로드코드란?', link: '/학습자료/1-클로드코드란' },
        {
          ...
          collapsed: false,
          items: [
            { text: '3-1. 스킬이란?', link: '/학습자료/2-스킬개념/2-1-스킬이란' },
            { text: '3-2. 공식스킬 체험', link: '/학습자료/2-스킬개념/2-2-공식스킬체험' },
            { text: '3-3. 첫 스킬 만들기', link: '/학습자료/2-스킬개념/2-3-첫스킬만들기' },
            { text: '3-4. 배포 및 공유', link: '/학습자료/2-스킬개념/2-4-배포및공유' },
          ],
        },
        {
          text: '4. 바이브코딩 기초',
          collapsed: false,
          items: [
            { text: '4-1. 바이브코딩?', link: '/학습자료/3-바이브코딩기초/3-1-바이브코딩' },
            { text: '4-2. CLAUDE.md', link: '/학습자료/3-바이브코딩기초/3-2-claudemd' },
            { text: '4-3. MCP 설명', link: '/학습자료/3-바이브코딩기초/3-3-mcp설명' },
            { text: '4-4. MCP 설치 실습', link: '/학습자료/3-바이브코딩기초/3-4-mcp설치실습' },
          ],
        },
        {
          text: '5. 워크샵 실습',
